...
window.GRID_DATA = {
  ...
  // Suzlon turbine platforms (rated MW / rotor m / typical hub m).
  turbines: {
    S144: { mw: 3.0,  rotor: 144,  hub: 140, status: "Flagship (current)" },
    S133: { mw: 2.9,  rotor: 133,  hub: 120, status: "Current" },
    S128: { mw: 2.7,  rotor: 128,  hub: 120, status: "Current" },
    S120: { mw: 2.1,  rotor: 120,  hub: 120, status: "Legacy (in O&M)" },
    S111: { mw: 2.1,  rotor: 111.8, hub: 90,  status: "Legacy (in field)" },
    S97:  { mw: 2.1,  rotor: 97,   hub: 90,  status: "Phased out" },
    S88:  { mw: 2.1,  rotor: 88,   hub: 90,  status: "Phased out" },
    S82:  { mw: 1.5,  rotor: 82,   hub: 78,  status: "Legacy" }
  },
  ...
  projects: [
    { id:"jaisalmer",  name:"Jaisalmer Wind Park",        state:"Rajasthan",      district:"Jaisalmer",  lat:26.92, lon:70.90, capacityMW:1064, turbineModel:"S97",  status:"energized",
    ...
    { id:"tejuva",     name:"Tejuva (CLP India)",         state:"Rajasthan",      district:"Jaisalmer",  lat:26.85, lon:70.85, capacityMW:100.8, turbineModel:"S97", status:"energized",
    ...
    { id:"kutch",      name:"Kutch Wind Park",            state:"Gujarat",        district:"Kutch",      lat:23.20, lon:69.50, capacityMW:1100, turbineModel:"S97", status:"energized",
    ...
    { id:"vankusawade", name:"Vankusawade Wind Park",     state:"Maharashtra",    district:"Satara",     lat:17.46, lon:73.83, capacityMW:210, turbineModel:"S82", status:"energized",
    ...
    { id:"brahmanvel", name:"Brahmanvel Wind Farm",       state:"Maharashtra",    district:"Dhule",      lat:21.25, lon:74.30, capacityMW:528, turbineModel:"S111", status:"commissioned",
    ...
    { id:"dhalgaon",   name:"Dhalgaon / Sangli Cluster",  state:"Maharashtra",    district:"Sangli",     lat:17.00, lon:74.50, capacityMW:278, turbineModel:"S111", status:"energized",
    ...
    { id:"muppandal",  name:"Muppandal–Aralvaimozhi",     state:"Tamil Nadu",     district:"Kanyakumari",lat:8.25, lon:77.59, capacityMW:1500, turbineModel:"S97", status:"energized",
    ...
    { id:"kayathar",   name:"Kayathar Wind Farm",         state:"Tamil Nadu",     district:"Thoothukudi",lat:8.95, lon:77.85, capacityMW:300, turbineModel:"S97", status:"commissioned",
    ...
    { id:"gadag",      name:"Gadag Wind Project",         state:"Karnataka",      district:"Gadag",      lat:15.42, lon:75.65, capacityMW:302, turbineModel:"S128", status:"construction",
    ...
    { id:"chitradurga",name:"Chitradurga Cluster",        state:"Karnataka",      district:"Chitradurga",lat:14.05, lon:76.47, capacityMW:120, turbineModel:"S111", status:"commissioned",
    ...
    { id:"anantapur",  name:"Anantapur Wind Farm",        state:"Andhra Pradesh", district:"Anantapur",  lat:14.68, lon:77.60, capacityMW:226.8, turbineModel:"S111", status:"energized",
    ...
    { id:"kurnool",    name:"Kurnool Cluster",            state:"Andhra Pradesh", district:"Kurnool",    lat:15.83, lon:78.04, capacityMW:200, turbineModel:"S128", status:"construction",
    ...
    { id:"ratlam",     name:"Ratlam Wind Farm",           state:"Madhya Pradesh", district:"Ratlam",     lat:23.30, lon:75.10, capacityMW:100, turbineModel:"S97", status:"construction",
    ...
    { id:"dewas",      name:"Dewas / Mahuria Cluster",    state:"Madhya Pradesh", district:"Dewas",      lat:22.95, lon:76.10, capacityMW:150, turbineModel:"S133", status:"planned",
